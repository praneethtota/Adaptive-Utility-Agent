...
class ContradictionDetector:
    ...
    def check(
        self, problem: str, solution: str, claimed_complexity: str | None = None
    ) -> ContradictionResult:
    ...
    def _check_syntax(self, solution: str, result: ContradictionResult):
        ...
        try:
            ...
            result.contradictions.append(
                Contradiction(
                    type="logical", description=f"Syntax error in generated code: {e}", severity=0.8
                )
            )
    ...
    def _check_complexity_claim(
        self, solution: str, claimed_complexity: str, result: ContradictionResult
    ):
        """
